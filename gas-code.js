...
var SPREADSHEET_ID = "1LdjBX6hLbidMw-LOTFpaAwbvvhzA8rlLqF2Vqv3yMUQ";

// シート名（★エッセンス力学・波動用。他教材と重複不可）
var SHEET_NAME_DATA = "EM_SRS_Data";    // ネクステ: NS, シス単: SRS_Data_v5, 基礎問IA: K1
var SHEET_NAME_META = "EM_SRS_Meta";    // ネクステ: NS, シス単: SRS_Meta, 基礎問IA: K1
...
function runAllTests() {
  Logger.log("========================================");
  Logger.log("エッセンス力学・波動 SRS GAS テスト実行 - " + new Date().toISOString());
  Logger.log("========================================");
...
function checkDataStatus() {
  ...
  if (sheet) {
    var lastRow = sheet.getLastRow();
    Logger.log("========================================");
    Logger.log("エッセンス力学・波動 SRS データ状態チェック");
    Logger.log("========================================");
